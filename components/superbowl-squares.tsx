				...
				<div className="max-w-4xl mx-auto space-y-8 relative z-10">
					...
					>
						...
						<ol className="list-decimal list-inside space-y-2 text-gray-700">
							...
							<li>Your selected squares will be highlighted in dark yellow.</li>
							<li>
							...
							<li className="font-bold">
								For example, if the score is Chiefs 17, Eagles 13 at the end of
								a quarter, the winning square would be where 7 (Chiefs) and 3
								(Eagles) intersect.
							</li>
							<li>
								Once you've selected your squares, click the "Checkout" button
								to complete your purchase. The board will automatically update
								with your selected squares.
							</li>
						</ol>
